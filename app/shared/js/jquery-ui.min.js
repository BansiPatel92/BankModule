(function (factory) { if (typeof define === "function" && define.amd) { define(["jquery"], factory); } else { factory(jQuery); } }(function ($) {
    ...
    $.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase()); $.fn.extend({
        ...
        }, _search: function (value) { this.pending++; this.element.addClass("ui-autocomplete-loading"); this.cancelSearch = false; this.source({ term: value }, this._response(value)); }, _response: function (value) {
            var index = ++this.requestIndex; return $.proxy(function (content) {
                content = jQuery.grep(content, function (a) { return a.toLowerCase().startsWith(value.toLowerCase()) }); if (index === this.requestIndex) { this.__response(content); }
