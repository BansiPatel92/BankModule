...
(function () {
    ...
    function slimScroll($document, $window, $compile) {
        ...
        function setScopeValues(scope, element, attrs) {
            ...
            if (attrs.id == 'dvcomparedetails') {
                height = window.innerHeight - $('.custoktable.tableslimscroll').outerHeight() - $('.modal-content .modal-header').outerHeight() - 420;
                
                if (height > 440) { height = 475; }
            }
            ...
            if (height == 455 && attrs.id == 'dvcomparedetails') { 
